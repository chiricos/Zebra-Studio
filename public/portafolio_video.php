        ...
        <section>
            ...
            <div id="content_works">
                ...
                <div class="francisco hidden pop_up">
                    <?php include("portafolio2_web_pop_up.php"); ?>
                </div>

                <div class="refisal hidden pop_up">
                    <?php include("portafolio3_web_pop_up.php"); ?>
                </div>

                <div class="blancox hidden pop_up">
                    <?php include("portafolio4_web_pop_up.php"); ?>
                </div>

                <div class="trocipollo hidden pop_up">
                    <?php include("portafolio5_web_pop_up.php"); ?>
                </div>

                <div class="condimentos hidden pop_up">
                    <?php include("portafolio6_web_pop_up.php"); ?>
                </div>

                <div class="nts hidden pop_up">
                    <?php include("portafolio7_web_pop_up.php"); ?>
                </div>

                <div class="mago hidden pop_up">
                    <?php include("portafolio8_web_pop_up.php"); ?>
                </div>

                <div class="cabarria hidden pop_up">
                    <?php include("portafolio9_web_pop_up.php"); ?>
                </div>

                <div class="chefrito hidden pop_up">
                    <?php include("portafolio10_web_pop_up.php"); ?>
                </div>

                <div class="campiña hidden pop_up">
                    <?php include("portafolio11_web_pop_up.php"); ?>
                </div>

                <div class="durena hidden pop_up">
                    <?php include("portafolio12_web_pop_up.php"); ?>
                </div>

                <div class="brisa hidden pop_up">
                    <?php include("portafolio13_web_pop_up.php"); ?>
                </div>

                <div class="benfor hidden pop_up">
                    <?php include("portafolio14_web_pop_up.php"); ?>
                </div>

                <div class="2014 hidden pop_up">
                    <?php include("portafolio15_web_pop_up.php"); ?>
                </div>
